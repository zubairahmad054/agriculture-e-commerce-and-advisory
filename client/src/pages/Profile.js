...
import validationinfob from "./validationinfob";
...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    seterror(validationinfob(newEntry));
  }, [Uname, email, loc, type]);
  ...
  const submitform = async (e) => {
    ...
    if (
      ...
      error.loc ||
      error.type ||
      /^((\+92)?(0092)?(92)?(0)?)(3)([0-9]{9})$/.test(phone) == false
    ) {
      setflag(false);
      ...
      Axios.post("http://localhost:1337/api/update", {
        ...
        //alert("Info Updated (Login Again) ");
      ...
      //   console.log(store);
      console.log(data);
      //   console.log(error.Uname, error.email, error.loc, error.type, "two");
    }
  };
  ...
  return (
    <Layout>
      <div className="grid w-80 m-auto my-5">
        ...
        <br />
        {error.Uname && (
          <p style={{ color: "red", fontSize: "20px" }}>{error.Uname}</p>
        )}
        ...
        <input
          className="border h-10 bg-gray-200 p-5 text-black placeholder:text-black rounded-md"
          type="number"
          name="number"
          id="number"
        ...
        <br />
        {error.phone &&(
                    <p style={{ color: "red", fontSize: "20px" }}>{error.phone}</p>
        )}
        ...
        <br />
        {error.loc && (
          <p style={{ color: "red", fontSize: "20px" }}>{error.loc}</p>
        )}
        {user?.type !== "ADMIN" && (
          <>
            <label className="mt-1 font-semibold">Type</label>
            <select
              className="border-2 bg-white text-black p-2 mt-2 rounded-md"
              style={{ width: "88%" }}
              name="user"
            ...
            {error.type && (
              <p style={{ color: "red", fontSize: "20px" }}>{error.type}</p>
            )}
          </>
        )}
        <br />
